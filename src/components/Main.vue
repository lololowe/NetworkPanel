...
const threadNum = ref(localStorage.threadNum ? Number(localStorage.threadNum) : 16)
const runBackground = ref(localStorage.runBackground ? localStorage.runBackground === 'true' : true)
